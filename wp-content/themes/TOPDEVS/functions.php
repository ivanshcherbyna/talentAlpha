...
function topdevs_footer_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
...
add_action('wp_enqueue_scripts', 'topdevs_footer_scripts'); // Add Custom Scripts to wp_head
add_action('wp_enqueue_scripts', 'lwp_styles'); // Add Theme Stylesheet
add_action('wp_enqueue_scripts', 'topdevs_styles'); // Add ZAGA Theme Stylesheet
